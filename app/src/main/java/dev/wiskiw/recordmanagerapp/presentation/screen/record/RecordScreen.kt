        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                ...
                Row(
                    ...
                    Icon(Icons.Filled.Add, stringResource(id = R.string.screen_record_bottom_bar_button_add_description))
                    Spacer(modifier = Modifier.width(MaterialTheme.size.one))
                    Text(stringResource(id = R.string.screen_record_bottom_bar_button_add_title))
                }
            }
        }
    )
